...
**중복되는 코드가 변하지 않는 코드뿐**이라면 **메소드**로 추출하는게 효율적이다. 그러나 아래의 코드(`JDBC`)에서는 메소드로 추출된 부분이 매번 변하는 부분이다.
...
<figure><img src="../../.gitbook/assets/image (2).png" alt=""><figcaption><p>전략 패턴</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image.png" alt=""><figcaption><p><strong>전략 패턴과 DI</strong></p></figcaption></figure>
